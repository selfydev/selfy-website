      ...
      <div className="relative z-10 h-full flex flex-col justify-between px-6 lg:px-12">
        ...
        <div className="flex-1 flex items-center pt-20">
          <div className="animate-fade-in-up">
            {/* Headline */}
            <h1 className="font-[family-name:var(--font-helvetica-now)] text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white leading-[0.95] tracking-tight max-w-4xl">
              Moments,
              <br />
              reinvented
            </h1>

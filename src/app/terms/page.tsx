...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Use for selfy.photo covering intellectual property, user obligations, prohibited activities, disclaimers, liability, and governing law in the UK.",
  alternates: {
    canonical: "/terms",
  },
};
...
export default function TermsPage() {
  return (
    <LegalShell label="Legal" title="Terms of Use" lastUpdated="July 08, 2021">
      <h2>AGREEMENT TO TERMS</h2>
      <p>
        These Terms of Use constitute a legally binding agreement made between you, whether personally or
        on behalf of an entity (&ldquo;you&rdquo;) and Selfy LTD (&ldquo;Company&ldquo;, &ldquo;we&rdquo;,
        &ldquo;us&rdquo;, or &ldquo;our&rdquo;), concerning your access to and use of the
        https://www.selfy.photo website as well as any other media form, media channel, mobile website or
        mobile application related, linked, or otherwise connected thereto (collectively, the
        &ldquo;Site&rdquo;). You agree that by accessing the Site, you have read, understood, and agreed to
        be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU
      ...
      <p>
        ...
        you about any changes by updating the &ldquo;Last updated&rdquo; date of these Terms of Use, and
        ...
        will be deemed to have been made aware of and to have accepted, the changes in any revised Terms of
        Use by your continued use of the Site after the date such revised Terms of Use are posted.
      </p>
      <p>
      ...
      <p>
        ...
        therein (the &ldquo;Marks&rdquo;) are owned or controlled by us or licensed to us, and are
        protected by copyright and trademark laws and various other intellectual property rights and unfair
      ...
      <p>
        ...
        you agree to comply with these Terms of Use; (4) you are not under the age of 13; (5) you are not a
      ...
      <p>
        11. Engage in any automated use of the system, such as using scripts to send comments or messages,
      ...
      <p>
        20. Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any
      ...
      <p>
        23. Make any unauthorized use of the Site, including collecting usernames and/or email addresses of
      ...
      <p>
        ...
        information regarding the Site (&ldquo;Submissions&rdquo;) provided by you to us are
      ...
      <h2>ADDITIONAL SERVICES AND ADD-ONS</h2>
      <p>
        By agreeing to use our services, you acknowledge and accept that certain add-ons and services
        included in our packages, including but not limited to wedding props, analytics, colour filters,
        digital face masks, and other similar assets, require prior request and preparation. These add-ons
        and services are not automatically provided but must be explicitly requested by you in advance.
      </p>
      <p>
        Failure to request these add-ons and services in advance will result in their unavailability during
        the use of the Selfy photo booth service. We shall not be held liable for any oversight on your
        part regarding these requests, and we are under no obligation to remind or inform you about the
        necessity of making such requests. The absence of any requested add-on or service does not entitle
        you to any form of compensation, refund, or any other claim against us.
      </p>
      ...
      <p>
        ...
        <a href="/privacy-policy">https://selfy.photo/privacy-policy</a>. By using the Site, you agree to
        be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised
        the Site is hosted in the United Kingdom. If you access the Site from any other region of the world
        with laws or other requirements governing personal data collection, use, or disclosure that differ
        from applicable laws in the United Kingdom, then through your continued use of the Site, you are
        transferring your data to the United Kingdom, and you agree to have your data transferred to and
      ...
      <h2>THIRD-PARTY PHOTO BOOTH SOFTWARE</h2>
      <p>
        Our photo booth company utilizes a third-party photo booth software to provide our services. While
        we take the privacy and security of our clients&apos; information very seriously, we are not
        responsible for any errors or issues that may occur with the software.
      </p>
      <p>
        Please be aware that the third-party photo booth software provider may collect and process your
        personal data, and we advise you to review their privacy policy and terms of service to understand
        how they handle your information.
      </p>
      <p>
        As per the General Data Protection Regulation (GDPR), we will do our best to ensure that any
        personal data collected and processed through our services is handled in a secure and transparent
        manner. However, we cannot be held responsible for any data breaches or issues that may arise from
        the use of the third-party software.
      </p>
      <p>
        By using our services, you acknowledge and agree to these terms regarding the third-party photo
        booth software.
      </p>

      <h2>GOVERNING LAW</h2>
      <p>
        These conditions are governed by and interpreted following the laws of the United Kingdom, and the
        use of the United Nations Convention of Contracts for the International Sale of Goods is expressly
        excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess
        the protection provided to you by obligatory provisions of the law of your country of residence.
        Selfy LTD and yourself both agree to submit to the non-exclusive jurisdiction of the courts of
        London, which means that you may make a claim to defend your consumer protection rights in regards
        to these Conditions of Use in the United Kingdom, or in the EU country in which you reside.
      </p>
      ...
      <p>
        ...
        the Site. Notwithstanding the foregoing, we reserve the right, at your expense, to assume the
